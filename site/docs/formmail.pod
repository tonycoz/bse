...
given by I<sql>.  If a field name is surrounded by {} then that field
is extracted from the currently logged on user, otherwise it's taken
as the name of one of the submitted form fields.
